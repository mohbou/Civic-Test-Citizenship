...
class QuestionListViewModel @Inject constructor(private val questionRepository: QuestionRepository,private val intentFactory: IntentFactory):ViewModel(),LifecycleObserver {
    ...
    sealed class ViewState {
        ...
        class ShowUpdateMessage(@StringRes val title:Int,@StringRes val message:Int):ViewState()
    ...
    suspend fun updateQuestionReview(question: Question) {
        ...
        if(question.review!!)
        viewState.value =ViewState.ShowUpdateMessage(R.string.update_review,R.string.review_selected)
        else
        viewState.value =ViewState.ShowUpdateMessage(R.string.update_review,R.string.review_unselected)
    }
